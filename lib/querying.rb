...
def select_series_title_with_most_human_characters
  "SELECT title, species_count FROM (SELECT series.title AS title, characters.species AS species_count FROM series INNER JOIN characters ON characters.species = 'human');"
end
