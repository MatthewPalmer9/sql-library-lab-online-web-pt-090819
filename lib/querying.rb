...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM (SELECT characters.species, COUNT(characters.species) FROM characters GROUP BY species ORDER BY COUNT(characters.species) DESC LIMIT 1);"
end
